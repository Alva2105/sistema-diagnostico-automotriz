            ...
            <div class="details">
                ...
                <div class="col">
                    ...
                    <div class="field">
                        ...
                        <div class="value">{{ $cliente->tel_cli ?? 'No registrado' }}</div>
                    </div>
                    <div class="field">
                        <div class="field-header">
                        ...
                        <div class="value">{{ $cliente->cod_clientes ?? 'No registrado' }}</div>
                    </div>
                    <div class="field">
                        <div class="field-header">
                        ...
                        <div class="value">{{ $cliente->dir_cli ?? 'No registrada' }}</div>
                    </div>
                </div>
            </div>
        </div>
